...
const FoundItemForm = () => {
  ...
  return (
    <div style={containerStyle}>
      {/* Modern Single-line Heading */}
      <div style={headerStyle}>
        <h2 style={headerTextStyle}>📦 Found Item Report</h2>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={formGroup}>
          <label><strong>Upload Image <span style={required}>*</span></strong></label>
          <input
            type="file"
            accept="image/*"
        ...
        <button type="submit" style={buttonStyle}>Submit Item</button>
      </form>
    </div>
  );
};
